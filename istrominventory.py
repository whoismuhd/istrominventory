...
with tab6:
    ...
    st.info("🔄 **New Actuals Tab Ready**: Please specify how you want the actuals tab to be structured.")
    st.caption("The old actuals tab has been removed. Tell me how you want the new one to work!")
